...
- (void)viewDidLoad {
    ...
    UIButton *jumBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 60, 30)];
    jumBtn.backgroundColor = [UIColor orangeColor];
    [jumBtn addTarget:self action:@selector(jump) forControlEvents:(UIControlEventTouchUpInside)];
    [_containView addSubview:jumBtn];
    
}


- (void)jump{
    WangYiWaveViewController *vc = [[WangYiWaveViewController alloc] init];
